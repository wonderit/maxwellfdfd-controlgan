...
file_name = 'samples_99999'
img_path = 'example_result/{}.png'.format(file_name)
...
csv_file_result_match = "{}_result_match.csv".format(file_name)
csv_file_result_top3 = "{}_result_top3.csv".format(file_name)
csv_file_result_top5 = "{}_result_top5.csv".format(file_name)
csv_file_result_truth = "{}_result_truth.csv".format(file_name)
