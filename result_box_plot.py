...
if __name__ == '__main__':
    ...
    parser.add_argument("-n", "--sample_number", help="Select sample_number", type=int, default=36000)

    args = parser.parse_args()
    folder_name = './logs/wgan_new'
    ...
    top5_accuracy = 0.0
    top_accuracy_id = 0
    for image_number in range(35099, args.sample_number, 100):
